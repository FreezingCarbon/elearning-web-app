<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="viewuser.aspx.cs" Inherits="user" %>
        ...
        <div class="content_resize">
            <div class="mainbar">
                <div class="article">
                    ...
                    <ul class="list-group">
                        <%ELearn.User usr = (ELearn.User)Session["viewUser"]; %>
